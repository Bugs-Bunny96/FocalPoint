            ...
            <div class="container">
                ...
                <div class="autCont">
                    <div class= "autPage" style="padding-top: 1px; padding-bottom: 28px;">
                        ...
                        <p class="aut-reg">
                        <a class="aut-link" href='aut.php' style="color: #000000; font-size: 24px;">ВХОД</a>
                        <a class="reg-link" href='reg.php'>РЕГИСТРАЦИЯ</a>
                        </p>
                        ...
                        <p class="input-board">
                            ...
                            <input class="input-pas" name="password" type="password" size="20" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Должен содержать по меньшей мере одну цифру, одну большую и одну маленькую буквы латинского алфавита и быть в длину не менее 8 символов" minlength="8" maxlength="32" placeholder="Введите пароль" style=" height: 27px;" >
                        </p>
                            <p>
