                    ...
                    <div class="content">
                        ...
                        <div class="main-div">
                            ...
                            <div clss="select-type">
                                ...
                                <a class="select-type-link" href="addTablet.php" style="color: #F3EAF3; font-size: 18px">Планшеты</a>
                            ...
                            <div class="addproduct">
                                 ...
                                 <form class="form-post" action="insertProducts.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <p>Тип продукта:
                                    <input type="radio" id="contactChoice1" name="type" value="Планшеты" required>
                                    <label for="contactChoice1">Планшеты</label></p>
                                        ...
                                        <input class="input-model-series" name="model_series" type="text" size="40" required minlength="1" maxlength="32"placeholder="Серия модели пример: Galaxy TAB A7" style=" height: 18px;" ><br>
                                        <br>

                                        <input class="input-processor" name="processor" type="text" size="40" required minlength="1" maxlength="32"placeholder="Процессор пример: Mediatek" style=" height: 18px;" ><br>
                                        <br>

                                        <input class="input-processor-series" name="processor_series" type="text" size="40" required minlength="1" maxlength="32"placeholder="Введите серию пример: Xelio P22T" style=" height: 18px;" ><br>
                                        <br>

                                        <label for="type-camera">Камера в MP пример: 10</label>
                                        <input id="type-camera" class="type-camera" name="camera" type="number" required min="1" max="999">
