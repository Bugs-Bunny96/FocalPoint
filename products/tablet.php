                ...
                <div class="break">
                    ...
                    <div class="sort">
                        <div class="sortContent">
                            ...
                            <form method="POST" action='filters/filtersTablet.php'>
                                <?php
                                // нужно для подсчёта остатка продукта по выбраным критериям 
                                    $model = !empty($_GET['manufacturer']) ? explode(',', $_GET['manufacturer']) : array('Xiaomi', 'Samsung', 'Apple', 'HP', 'Lenovo', 'Honor', 'Huawei');
                                    $ram = !empty($_GET['ram']) ? explode(',', $_GET['ram']) : array('2 GB', '3 GB', '4 GB', '6 GB', '8 GB', '10 GB', '12 GB');
                                    $volum_drive = !empty($_GET['volum_drive']) ? explode(',', $_GET['volum_drive']) : array('32 GB', '64 GB', '128 GB', '256 GB', '512 GB', '1 TB');
                                    $diagonal = !empty($_GET['diagonal']) ? explode(',', $_GET['diagonal']) : array('8”', '8.7”', '10.1”', '10.3”', '10.4”', '10.5”', '10.6”', '11”', '11.5”');
                                    $resolution = !empty($_GET['resolution']) ? explode(',', $_GET['resolution']) : array('HD', 'FHD', 'WXGA', 'WUXGA', 'UHD', 'WQXGA');
                                    $frequency = !empty($_GET['frequency']) ? explode(',', $_GET['frequency']) : array('60 Hz', '90 Hz', '120 Hz', '144 Hz');
                                ?>
                                ...
                                <div id="filter-container">
                                            ...
                                            <ul class="filter-list">
                                                <?php
                                                    ...
                                                    $options = array(
                                                        ...
                                                        'Apple' => 'manufacturerChoice3',
                                                        'HP' => 'manufacturerChoice4',
                                                        'Lenovo' => 'manufacturerChoice5',
                                                        'Honor' => 'manufacturerChoice6',
                                                        'Huawei' => 'manufacturerChoice7'
                                                    );

                                                    foreach ($options as $option => $id) {
                                                        $query = "SELECT COUNT(model) AS quant FROM `t_products` WHERE type = 'Планшеты' AND model = '$option' 
                                                        AND ram IN ('" . implode("', '", $ram) . "') AND volum_drive IN ('" . implode("', '", $volum_drive) . "') 
                                                        AND diagonal IN ('" . implode("', '", $diagonal) . "') AND resolution IN ('" . implode("', '", $resolution) . "')
                                                        AND frequency IN ('" . implode("', '", $frequency) . "')";
                                    ...
                                    <p class="textFilter" data-target="js-filter-content2" onclick="changeClass(event)">Оперативная память &nbsp<i id="js-filter-icon-down2" class="up"></i></p>
                                    <div class="div-close-filter">
                                        <div id="js-filter-content2"> 
                                            <ul class="filter-list">
                                                <?php
                                                    ...
                                                    foreach ($options as $option => $id) {
                                                        $query = "SELECT COUNT(ram) AS quant FROM `t_products` WHERE type = 'Планшеты' AND model IN ('" . implode("', '", $model) . "')
                                                        AND ram = '$option' AND volum_drive IN ('" . implode("', '", $volum_drive) . "') AND diagonal IN ('" . implode("', '", $diagonal) . "') 
                                                        AND resolution IN ('" . implode("', '", $resolution) . "') AND frequency IN ('" . implode("', '", $frequency) . "')";
                                    ...
                                    <p class="textFilter" data-target="js-filter-content3" onclick="changeClass(event)">Объём накопителя &nbsp<i id="js-filter-icon-down3" class="up"></i></p>
                                    <div class="div-close-filter">
                                        <div id="js-filter-content3"> 
                                            <ul class="filter-list">
                                                <?php
                                                    ...
                                                    $options = array(
                                                        '32 GB' => 'volumdriveChoice1',
                                                        '64 GB' => 'volumdriveChoice2',
                                                        '128 GB' => 'volumdriveChoice3',
                                                        '256 GB' => 'volumdriveChoice4',
                                                        '512 GB' => 'volumdriveChoice5',
                                                        '1 TB' => 'volumdriveChoice6'
                                                    );

                                                    foreach ($options as $option => $id) {
                                                        $query = "SELECT COUNT(volum_drive) AS quant FROM `t_products` WHERE type = 'Планшеты' AND model IN ('" . implode("', '", $model) . "')
                                                        AND ram IN ('" . implode("', '", $ram) . "') AND volum_drive = '$option' AND diagonal IN ('" . implode("', '", $diagonal) . "') 
                                                        AND resolution IN ('" . implode("', '", $resolution) . "') AND frequency IN ('" . implode("', '", $frequency) . "')";
                                    ...
                                    <p class="textFilter" data-target="js-filter-content4" onclick="changeClass(event)">Диагональ &nbsp<i id="js-filter-icon-down4" class="up"></i></p>
                                    <div class="div-close-filter">
                                            ...
                                            <ul class="filter-list">
                                                <?php
                                                    ...
                                                    $options = array(
                                                        '8”' => 'diagonalChoice1',
                                                        '8.7”' => 'diagonalChoice2',
                                                        '10.1”' => 'diagonalChoice3',
                                                        '10.3”' => 'diagonalChoice4',
                                                        '10.4”' => 'diagonalChoice5',
                                                        '10.5”' => 'diagonalChoice6',
                                                        '10.6”' => 'diagonalChoice7',
                                                        '11”' => 'diagonalChoice8',
                                                        '11.5”' => 'diagonalChoice9'
                                                    );

                                                    foreach ($options as $option => $id) {
                                                        $query = "SELECT COUNT(diagonal) AS quant FROM `t_products` WHERE type = 'Планшеты' AND model IN ('" . implode("', '", $model) . "')
                                                        AND ram IN ('" . implode("', '", $ram) . "') AND volum_drive IN ('" . implode("', '", $volum_drive) . "') AND diagonal = '$option' 
                                                        AND resolution IN ('" . implode("', '", $resolution) . "') AND frequency IN ('" . implode("', '", $frequency) . "')";
                                    ...
                                    <p class="textFilter" data-target="js-filter-content5" onclick="changeClass(event)">Разрешение &nbsp<i id="js-filter-icon-down5" class="up"></i></p>
                                    <div class="div-close-filter">
                                            ...
                                            <ul class="filter-list">
                                                <?php
                                                    ...
                                                    $options = array(
                                                        ...
                                                        'WXGA' => 'resolutionlChoice3',
                                                        'WUXGA' => 'resolutionlChoice4',
                                                        'UHD' => 'resolutionlChoice5',
                                                        'WQXGA' => 'resolutionlChoice6'
                                                    );

                                                    foreach ($options as $option => $id) {
                                                        $query = "SELECT COUNT(resolution) AS quant FROM `t_products` WHERE type = 'Планшеты' AND model IN ('" . implode("', '", $model) . "')
                                                        AND ram IN ('" . implode("', '", $ram) . "') AND volum_drive IN ('" . implode("', '", $volum_drive) . "') 
                                                        AND diagonal IN ('" . implode("', '", $diagonal) . "') AND resolution = '$option' AND frequency IN ('" . implode("', '", $frequency) . "')";
                                    ...
                                    <p class="textFilter" data-target="js-filter-content6" onclick="changeClass(event)">Частота &nbsp<i id="js-filter-icon-down6" class="up"></i></p>
                                    <div class="div-close-filter">
                                            ...
                                            <ul class="filter-list">
                                                <?php
                                                    ...
                                                    $options = array(
                                                        ...
                                                        '90 Hz' => 'frequencyChoice2',
                                                        '120 Hz' => 'frequencyChoice3',
                                                        '144 Hz' => 'frequencyChoice4'
                                                    );

                                                    foreach ($options as $option => $id) {
                                                        $query = "SELECT COUNT(frequency) AS quant FROM `t_products` WHERE type = 'Планшеты' AND model IN ('" . implode("', '", $model) . "')
                                                        AND ram IN ('" . implode("', '", $ram) . "') AND volum_drive IN ('" . implode("', '", $volum_drive) . "')
                            ...
                            <?php
                                ...
                                '<a href=""><button class="reset_filter" name="reset_filter_btn" value="resetTablet">Сбросить фильтр</button></a>'.
                                '</form>';
                            ?>
                    ...
                    <div class="place">
                        ...
                        <?php
                            session_start();
                            require_once "../bd.php";
                            $query2 = $_SESSION['selectTablet'];
                            //var_dump($query2);

                            if (empty($query2)) {
                                $query2 = 'SELECT * FROM `t_products` WHERE type = "Планшеты"';
                              }
                                ...
                                if (!isset($_SESSION['id'])) {
                                    ...
                                    if ($role === "role_admin") {
                                        echo'<div class="div-down">'.
                                            ...
                                            '<div class="div-down1">'.
                                                '<a href="../updateProducts/updateT.php?id='.$row['id'].'"><button class="div-down1-button" name="editBtn">Изменить</button></a>'.
                                            '</div>';
                                    }else{
