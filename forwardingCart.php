        ...
        <section class="first-screen">
            <div class="container">
                <header class="main-header">
                    ...
                    <p class="textforward">Корзина не доступна!<br>Для доступа в корзину нужно пройти авторизацию.<br>Если вы ещё не зарегестрированы, нужно пройти регистрацию.</p>
