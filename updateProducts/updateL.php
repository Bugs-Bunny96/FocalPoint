                        ...
                        <div class="main-div">
                            ...
                            <div class="addproduct">
                                ...
                                <form class="form-post" action="updateProducts.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <p>Тип продукта:
                                    <input type="radio" id="contactChoice1" name="type" value="Ноутбуки" checked>
                                    <label for="contactChoice1">Ноутбуки</label></p>
                                        ...
                                        <br><br>
                                        <input class="input-model-series" name="model_series" type="text" value="'.$product['model_series'] .'" size="40" required minlength="1" maxlength="32"placeholder="Серия модели пример: Swift 3" style=" height: 18px;" ><br>
                                        <br>
                                        ...
                                        <div class="btn">
                                            <input class="submitbtn" type="submit" name="submit-upd-L" value="Изменить продукт">
                                        </div>
