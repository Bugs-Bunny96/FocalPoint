                        ...
                        <div class="main-div">
                            ...
                            <div class="addproduct">
                                ...
                                <form class="form-post" action="updateProducts.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <p>Тип продукта:
                                    <input type="radio" id="contactChoice1" name="type" value="Системные блоки" checked>
                                    <label for="contactChoice1">Системные блоки</label></p>

                                        <input class="input-model" name="model" type="text" value="'.$product['model'] .'" size="40" required minlength="1" maxlength="32"placeholder="Название комплекта пример: i5 или R3" style=" height: 18px;" ><br>
                                        <br>

                                        <label for="processor">Процессор:</label>
                                        <select id="processor" name="processor" required>
                                            <option selected >'.$product['processor'] .'</option>
                                            <option value="Intel Core">Intel Core</option>
                                            <option value="AMD">AMD</option>
                                        </select>

                                        <br><br>
                                        <input class="input-processor-series" name="processor_series" type="text" value="'.$product['processor_series'] .'" size="40" required minlength="1" maxlength="32"placeholder="Номер процессора пример: I5-11300" style=" height: 18px;" ><br>
                                        <br>

                                        <label for="type-video-card">Выберите тип видеокарты:</label>
                                        <select id="type-video-card" name="type_video_card" required>
                                            <option selected >'.$product['type_video_card'] .'</option>
                                        ...
                                        <select id="video-card" name="video_card" required>
                                            <option selected >'.$product['video_card'] .'</option>
                                        ...
                                        <br><br>
                                        <input class="input-video-card-series" name="video_card_series" type="text" value="'.$product['video_card_series'] .'" size="40" required minlength="1" maxlength="32"placeholder="Серия видеокарты пример: RTX 2050" style=" height: 18px;" ><br>
                                        <br>
                                        ...
                                        <select id="type-drive" name="type_drive" required>
                                            <option selected >'.$product['type_drive'] .'</option>
                                        ...
                                        <select id="port-lan" name="port_lan" required>
                                            <option selected >'.$product['port_lan'] .'</option>
                                        ...
                                        <select id="video" name="video" required>
                                            <option selected >'.$product['video'] .'</option>
                                        ...
                                        <select id="input-battery" name="battery" required>
                                            <option selected >'.$product['battery'] .'</option>
                                        ...
                                        <input id="price" class="input-price" name="price" value="'.$product['price'] .'" type="number" required min="1" max="999999">
                                        <br><br>

                                        <label for="quantity">Количество пример: 10</label>
                                        <input id="quantity" class="input-quantity" name="quantity" value="'.$product['quantity'] .'" type="number" required min="1" max="99">
                                        <br><br>
                                        
                                        <label for="warranty">Введите гарантию в месяцах пример: 12</label>
                                        <input id="warranty" class="input-warranty" name="warranty" value="'.$product['warranty'] .'" type="number" required min="1" max="30">
                                        <br><br>
                                        ...
                                        <div class="btn">
                                            <input class="submitbtn" type="submit" name="submit-upd-SB" value="Изменить продукт">
                                        </div>
