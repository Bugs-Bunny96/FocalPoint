                        ...
                        <div class="main-div">
                            ...
                            <div class="addproduct">
                                ...
                                <form class="form-post" action="updateProducts.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <p>Тип продукта:
                                    <input type="radio" id="contactChoice1" name="type" value="Мониторы" checked>
                                    <label for="contactChoice1">Мониторы</label></p>
                                        ...
                                        <select id="type-screen" name="screen_type" required>
                                            <option selected >'.$product['screen_type'] .'</option>
                                        ...
                                        <select id="speaker" name="speaker" required>
                                            <option selected >'.$product['speaker'] .'</option>
                                        ...
                                        <div class="btn">
                                            <input class="submitbtn" type="submit" name="submit-upd-M" value="Изменить продукт">
                                        </div>
