                ...
                <header class="main-header">
                    ...
                    echo'<div class="div-select">
                        <div clss="select-status">
                            ...
                            <a class="select-status-link" href="ordersPageDeliver.php" style="color: #F3EAF3; font-size: 18px">Доставлен</a>
                            ...
                            if($num3>0) {
                                ...
                                while ($row3=mysqli_fetch_array($result3, MYSQLI_ASSOC)) {
                                    $number=$number+1;
                                        ...
                                        <form class="changeStatus" action="changeStatusD.php" method="POST" style="margin-right: 10px;"><br>
